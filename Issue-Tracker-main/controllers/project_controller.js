...
//this is mainly for visiting a bug issue file

//that if a project contains bug then this controller will be called 
//and here we can also create new bug along with project

///lets run and check the project


// Thank you for wathcing so patiently